...
public class Call_Details extends AppCompatActivity {
    ...
    Button submit,callLater,notInterested,interested,notPicked,uploadFileToserver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolBarHeading.setText("Update Status ");
    ...
    private void setuploadFunction() {
        uploadFileToserver = findViewById(R.id.uploadFileToserver);
        uploadFileToserver.setOnClickListener(new View.OnClickListener() {
            @Override
    ...
    private void uploadVideoToServer(String path) {
        UploadClass uploadClass = new UploadClass(this,path);
    ...
    public void onBackPressed() {
        Intent i = new Intent(Call_Details.this, Missed_Call.class);
        startActivity(i);
        //super.onBackPressed();
    }
